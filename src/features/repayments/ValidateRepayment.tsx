...
export default function ValidateRepayment() {
  ...
  useEffect(() => {
    ...
    const run = async () => {
      try {
        await Axios({
          ...SummaryApi.validate_reimbursement_by_unique_link,
          params: { token },
        });
        setStatus('success');
      } catch (err: unknown) {
          ...
          <div className="px-8 py-10 text-center">
            ...
            {status === 'success' && (
              <>
                ...
                <h1 className="text-xl font-bold text-gray-900 dark:text-white mb-2">
                  Remboursement validée avec succès
                </h1>
                <p className="text-sm text-gray-500 dark:text-gray-400 leading-relaxed">
                  Vous avez confirmé cet remboursement. L'huissier en charge a été notifié automatiquement.
                </p>
