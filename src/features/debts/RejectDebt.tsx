...
export default function RejectDebt() {
  ...
  useEffect(() => {
    ...
    const run = async () => {
      try {
        await Axios({
          ...SummaryApi.reject_debt_by_unique_link,
          params: { token },
        });
        setStatus('success');
      } catch (err: unknown) {
          ...
          <div className="px-8 py-10 text-center">
            ...
            {status === 'success' && (
              <>
                ...
                <h1 className="text-xl font-bold text-gray-900 dark:text-white mb-2">
                  Dette rejetée avec succès
                </h1>
                <p className="text-sm text-gray-500 dark:text-gray-400 leading-relaxed">
                  Vous avez rejeté cette dette. L'huissier en charge a été notifié automatiquement.
                </p>
